...
module M = {
  ...
  proc load_last_add (h:W64.t Array3.t, in_0:W64.t, len:W64.t) : W64.t Array3.t = {
    ...
    if (((W64.of_int 8) \ule len)) {
      ...
      s.[(W64.to_uint j)] <- c64;
      len <- (len - (W64.of_int 8));
      j <- (j + (W64.of_int 1));
    } else {
      
    }
    j <- (j `<<` (W8.of_int 1));
    if (((W64.of_int 4) \ule len)) {
      ____UNIT____ <- LFENCE ;
      c32 <- (loadW32 Glob.mem (W64.to_uint (in_0 + ((W64.of_int 4) * j))));
      s <-
      Array2.init
      (WArray16.get64 (WArray16.set32 (WArray16.init64 (fun i => s.[i])) (W64.to_uint j) c32));
      len <- (len - (W64.of_int 4));
      j <- (j + (W64.of_int 1));
    } else {
      
    }
    j <- (j `<<` (W8.of_int 1));
    if (((W64.of_int 2) \ule len)) {
      ____UNIT____ <- LFENCE ;
      c16 <- (loadW16 Glob.mem (W64.to_uint (in_0 + ((W64.of_int 2) * j))));
      s <-
      Array2.init
      (WArray16.get64 (WArray16.set16 (WArray16.init64 (fun i => s.[i])) (W64.to_uint j) c16));
      len <- (len - (W64.of_int 2));
      j <- (j + (W64.of_int 1));
    } else {
      
    }
    j <- (j `<<` (W8.of_int 1));
    if (((W64.of_int 1) \ule len)) {
      ____UNIT____ <- LFENCE ;
      c8 <- (loadW8 Glob.mem (W64.to_uint (in_0 + j)));
      s <-
      Array2.init
      (WArray16.get64 (WArray16.set8 (WArray16.init64 (fun i => s.[i])) (W64.to_uint j) c8));
      j <- (j + (W64.of_int 1));
    } else {
  ...
  proc poly1305_ref3_update (s_in:W64.t, in_0:W64.t, inlen:W64.t,
                             h:W64.t Array3.t, r:W64.t Array3.t) : W64.t *
                                                                   W64.t *
                                                                   W64.t Array3.t = {
    var ____UNIT____ : unit;
    ...
    if (((W64.of_int 16) \ule inlen)) {
      ____UNIT____ <- LFENCE ;
      in_0 <- ((inlen \ult (W64.of_int 16)) ? s_in : in_0);
      inlen <- ((inlen \ult (W64.of_int 16)) ? r16 : inlen);
      h <@ load_add (h, in_0);
      h <@ mulmod (h, r);
  ...
  proc poly1305_ref3_local (out:W64.t, in_0:W64.t, inlen:W64.t, k:W64.t) : unit = {
    ...
    s_in <- in_0;
    ____UNIT____ <- LFENCE ;
    (in_0, len, h) <@ poly1305_ref3_update (s_in, in_0, len, h, r);
  ...
  proc poly1305_avx2_setup (r:W64.t Array3.t) : W256.t Array5.t *
    ...
    while (i < 3) {
      ...
      l <- rt.[0];
      ( _10,  _11,  _12,  _13,  _14, l) <- SHRD_64 l rt.[1] (W8.of_int 52);
      h <- l;
      l <- (l `&` (W64.of_int mask26));
      r1234 <-
      Array5.init
      ...
      l <- rt.[1];
      ( _15,  _16,  _17,  _18,  _19, l) <- SHRD_64 l rt.[2] (W8.of_int 40);
      r1234 <-
      Array5.init
  ...
  proc load_avx2 (in_0:W64.t, mask26:W256.t, s_bit25:W256.t) : W256.t Array5.t *
    ...
    m.[0] <- VPERM2I128 t m.[1] (W8.of_int (0 %% 2^4 + 2^4 * 2));
    m.[1] <- VPERM2I128 t m.[1] (W8.of_int (1 %% 2^4 + 2^4 * 3));
  ...
  proc pack_avx2 (h:W256.t Array5.t) : W64.t Array3.t = {
    ...
    u.[0] <- VPERM2I128 t.[0] t.[1] (W8.of_int (0 %% 2^4 + 2^4 * 2));
    u.[1] <- VPERM2I128 t.[0] t.[1] (W8.of_int (1 %% 2^4 + 2^4 * 3));
  ...
  proc mainloop_avx2_v1 (h:W256.t Array5.t, m:W256.t Array5.t, in_0:W64.t,
    ...
    t.[3] <- (t.[3] \vadd64u256 u.[3]);
    u.[0] <- VPMULU h.[0] r2;
    m.[0] <- VPERM2I128 m0 m.[1] (W8.of_int (0 %% 2^4 + 2^4 * 2));
    u.[1] <- VPMULU h.[1] r2;
    m.[1] <- VPERM2I128 m0 m.[1] (W8.of_int (1 %% 2^4 + 2^4 * 3));
    u.[2] <- VPMULU h.[2] r2;
    t.[2] <- (t.[2] \vadd64u256 u.[0]);
    r3x5 <- s_rx5.[(3 - 1)];
    t.[3] <- (t.[3] \vadd64u256 u.[1]);
  ...
  proc poly1305_avx2_update (s_in:W64.t, in_0:W64.t, len:W64.t,
                             r4444:W256.t Array5.t, r4444x5:W256.t Array4.t,
                             r1234:W256.t Array5.t, r1234x5:W256.t Array4.t) : 
  W64.t * W64.t * W64.t Array3.t = {
    var aux: int;
    var ____UNIT____ : unit;
    ...
    while (((W64.of_int 128) \ule len)) {
      in_0 <- ((len \ult (W64.of_int 128)) ? s_in : in_0);
      len <- ((len \ult (W64.of_int 128)) ? r128 : len);
  ...
  proc poly1305_avx2_wrapper (out:W64.t, in_0:W64.t, inlen:W64.t, k:W64.t) : unit = {
    ...
    (in_0, len, h) <@ poly1305_avx2_update (s_in, in_0, len, r4444, r4444x5,
    r1234, r1234x5);
    (in_0, len, h) <@ poly1305_ref3_update (s_in, in_0, len, h, r);
    poly1305_ref3_last (out, in_0, len, k, h, r);
    return ();
  ...
  proc poly1305_avx2_v4_safe_movcc_last (out:W64.t, in_0:W64.t, inlen:W64.t,
                                         k:W64.t) : unit = {
    var ____UNIT____ : unit;
